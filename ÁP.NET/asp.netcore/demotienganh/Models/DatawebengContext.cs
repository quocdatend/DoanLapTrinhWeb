...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PHUNG_DAT;Initial Catalog=DATAWEBENG;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Examid).HasName("PK__EXAMS__8D5AA6D0DE6CB055");
        ...
        {
            entity.HasKey(e => e.Name).HasName("PK__GRAMMAR__D9C1FA01A9B99353");
        ...
        {
            entity.HasKey(e => new { e.Id, e.Name }).HasName("PK__TESTGRAM__3F88F387D3D57BBF");
            ...
            entity.HasOne(d => d.NameNavigation).WithMany(p => p.Testgrammars)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__TESTGRAMMA__NAME__4316F928");
        });

        modelBuilder.Entity<Testvocabulary>(entity =>
        {
            entity.HasKey(e => new { e.Id, e.Nameen }).HasName("PK__TESTVOCA__9952ED4A3569B1A2");
            ...
            entity.HasOne(d => d.NameenNavigation).WithMany(p => p.Testvocabularies)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__TESTVOCAB__NAMEE__3D5E1FD2");
        });
        ...
        modelBuilder.Entity<UserResponse>(entity =>
        {
            ...
            entity.HasOne(d => d.Exam).WithMany(p => p.UserResponses)
                .HasForeignKey(d => d.ExamId)
                .HasConstraintName("FK__UserRespo__ExamI__4E88ABD4");
        ...
        {
            entity.HasKey(e => e.Nameen).HasName("PK__VOCABULA__B46016DB48D41912");
